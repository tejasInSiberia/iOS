...
-(void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(ctx, [_color colorWithAlphaComponent:0.3].CGColor);
    CGContextStrokePath(ctx);
    
    // Progress Arc:
    CGContextBeginPath(ctx);
    CGContextAddArc(ctx, 0, 0, radius, 0, endAngle, 0);
    CGContextSetStrokeColorWithColor(ctx, [_color colorWithAlphaComponent:1.0].CGColor);
    CGContextStrokePath(ctx);
