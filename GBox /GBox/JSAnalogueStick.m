...
- (void)commonInit
{
	...
	_handleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Left Joy"]];
	CGRect handleImageFrame = [_handleImageView frame];
	handleImageFrame.size = CGSizeMake([_backgroundImageView bounds].size.width /1.3,
									   [_backgroundImageView bounds].size.height /1.3);
