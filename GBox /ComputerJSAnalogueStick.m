...
@implementation ComputerJSAnalogueStick
...
- (void)commonInit
{
	_backgroundImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Xjoyback"]];
	...
	_handleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"Xjoybut"]];
	CGRect handleImageFrame = [_handleImageView frame];
	handleImageFrame.size = CGSizeMake([_backgroundImageView bounds].size.width / 1.2,
									   [_backgroundImageView bounds].size.height / 1.2);
